...
class Sokkatte_consumer(AsyncWebsocketConsumer):
    ...
    async def sort_connected_dict(self, connected_dict):
        ...
        logger.info(f"Sorting connected_dict: {connected_dict} based on players: {players}")
        ...
        logger.info(f"Sorted connected_dict: {sorted_dict}")
        return sorted_dict
        ...
        if self.username in self.completed_players:
            ...
            try: 
                ...
                if self.username not in self.connected_dict:
                    ...
                    self.connected_dict= await self.sort_connected_dict(self.connected_dict)
